...
{ 
    ...
    { 
        ...
        /// <summary>
        /// Gets or Sets IsSnapFriendly
        /// </summary>

        [DataMember(Name="isSnapFriendly")]
        ...
        /// <summary>
        /// Gets or Sets OperatingDays
        /// </summary>

        [DataMember(Name="operatingDays")]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsSnapFriendly: ").Append(IsSnapFriendly).Append("\n");
            sb.Append("  OperatingHours: ").Append(OperatingHours).Append("\n");
            sb.Append("  OperatingDays: ").Append(OperatingDays).Append("\n");
        ...
        public bool Equals(FarmersMarket other)
        {
            ...
            return 
                ...
                (
                    IsSnapFriendly == other.IsSnapFriendly ||
                    IsSnapFriendly != null &&
                    IsSnapFriendly.Equals(other.IsSnapFriendly)
                ) && 
                (
                ...
                (
                    OperatingDays == other.OperatingDays ||
                    OperatingDays != null &&
                    OperatingDays.Equals(other.OperatingDays)
                ) && 
                (
                    OperatingMonths == other.OperatingMonths ||
                    OperatingMonths != null &&
                    OperatingMonths.Equals(other.OperatingMonths)
                ) && 
                (
                    Phone == other.Phone ||
                    Phone != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                // Suitable nullity checks etc, of course :)
                    ...
                    if (IsSnapFriendly != null)
                    hashCode = hashCode * 59 + IsSnapFriendly.GetHashCode();
                    if (OperatingHours != null)
                    hashCode = hashCode * 59 + OperatingHours.GetHashCode();
                    if (OperatingDays != null)
                    hashCode = hashCode * 59 + OperatingDays.GetHashCode();
